export default function Reports() {
  ...
  const cardClass =
    "block w-full h-full p-8 bg-white hover:bg-gray-100 flex flex-col items-center justify-center text-center border-2 border-gray-300 rounded-xl shadow-lg hover:shadow-xl hover:border-gray-400 transition duration-300";
